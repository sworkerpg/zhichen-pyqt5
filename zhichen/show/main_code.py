...
#pyqt_plugins = os.path.join("C:", "ProgramData", "Anaconda3", "Lib","site-packages","PyQt5", "Qt", "plugins")
pyqt_plugins = os.path.dirname("C:/Users/Terry/AppData/Roaming/Python/Python36/site-packages/PyQt5/Qt/plugins/")
#pyqt_plugins = os.path.dirname("C:/ProgramData/Anaconda3/Lib/site-packages/PyQt5/Qt/plugins/")
print(pyqt_plugins)
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        comName = QLabel(self)
        pngPath = os.path.join(os.path.dirname(proPath), "img", "lg.png")
        ...
        stylesheetPath = os.path.join(os.path.dirname(proPath),"stylesheet", "stylesheet.txt")
        # 导入样式表
        ...
        logoPath = os.path.join(os.path.dirname(proPath), "img", "logo.png")
